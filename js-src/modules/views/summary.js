...
module.exports = {
    ...
    renderEquippedUpgrade: function (upgrade) {
        ...
        $li.append('<div class="full"><img src="' + imageUrl + '" alt="Card image for ' + upgrade.name + '"></div>');
    ...
    renderEquippedAbility: function (ability) {
        ...
        $li.append('<div class="full ability"><span class="title">' + ability.name + '</span><span class="name">Ability</span><span class="text">' + escapedText + '</span></div>');
